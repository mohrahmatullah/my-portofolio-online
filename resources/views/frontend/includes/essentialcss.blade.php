...
<link href="{{url('public/frontend/assets/vendor/icofont/icofont.min.css')}}" rel="stylesheet">
<link href="{{url('public/frontend/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
<link href="{{url('public/frontend/assets/vendor/venobox/venobox.css')}}" rel="stylesheet">
<link href="{{url('public/frontend/assets/vendor/owl.carousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
